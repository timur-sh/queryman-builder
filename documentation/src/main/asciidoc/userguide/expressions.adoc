...
The `PostgreSQL` class provides convenient methods creating any expressions. Some examples
...
===== Constants: PostgreSQL.asConstant() and other constant-methods
...
===== Column reference: PostgreSQL.asName, PostgreSQL.asQuotedName
...
===== List constructor: PostgreSQL.asList
...
===== Subquery: PostgreSQL.asSubquery
